...
export default function Home() {
  return (
    <>
      <Head>
        <title>Salamander Tech Hub : GitHub Profile ReadMe Maker</title>
        {/* Meta tags dynamically generated by metaSEO (https://metaseo.itsvg.in) */}
        <meta
          name="title"
          content="Salamander Tech Hub : GitHub Profile ReadMe Maker"
        />
        <meta
          name="description"
      ...
      <>
        <CrispBanner />
        <div className="overflow-x-hidden max-w-[100vw] p-3 md:p-4 text-yellow-100">
          <Broadcast />
          <NavBar />
          <HomePage />
          <Footer />
